package com.smartcare.navigation;
...
class NavigationIntegrationTest {
    ...
    void routesUseVerifiedGraphAndStepFreePreferenceInsteadOfGuessing() throws Exception {
        var hospital = createHospital("SC-NAV-1");
        ...
        navigation.createCheckpoint(hospital.id(), new CheckpointRequest("ENTRY", "SC-NAV-ENTRY",
                "Entrance QR", "प्रवेश QR"));

        var quickest = navigation.route(hospital.id(), "SC-NAV-ENTRY", "ROOM_12", "en", false);
        ...
        var accessibleHindi = navigation.route(hospital.id(), "SC-NAV-ENTRY", "ROOM_12", "hi-IN", true);
        ...
        var unavailable = navigation.route(hospital.id(), "SC-NAV-ENTRY", "ISOLATED", "en", true);
        ...
        mvc.perform(get("/api/v1/navigation/hospitals/{hospitalId}/route", hospital.id())
                        .param("fromCheckpoint", "SC-NAV-ENTRY")
    ...
    void appointmentDestinationRequiresOwnershipAndExactVerifiedRoom() {
        ...
        var hospital = createHospital("SC-NAV-2");
        ...
        var doctor = doctors.create(new DoctorRequest(hospital.id(), department.id(), "Dr. Route Test",
                "Medicine", "SC-NAV-REG-2", new BigDecimal("600.00"), 15, 12,
    ...
    void appointmentDestinationFallsBackToVerifiedHelpDeskInsteadOfReturningBlankMap() {
        LocalDate visitDate = LocalDate.now();
        var hospital = createHospital("SC-NAV-3");
        var department = hospitals.createDepartment(hospital.id(),
        ...
        var doctor = doctors.create(new DoctorRequest(hospital.id(), department.id(), "Dr. Unmapped Room",
                "Neurology", "SC-NAV-REG-3", new BigDecimal("800.00"), 15, 12,
    ...
    private com.smartcare.hospital.web.HospitalDtos.HospitalResponse createHospital(String code) {
