package com.raahmediq.medicalrecord;
...
import com.raahmediq.medicalrecord.domain.AllergySeverity;
import com.raahmediq.medicalrecord.domain.DocumentType;
import com.raahmediq.medicalrecord.service.MedicalRecordService;
import com.raahmediq.medicalrecord.web.MedicalRecordDtos.AllergyRequest;
import com.raahmediq.medicalrecord.web.MedicalRecordDtos.PrescriptionItemRequest;
...
class MedicalRecordIntegrationTest {
    ...
    void finalizedVisitAndPrivateDocumentRemainPatientIsolatedAndAudited() {
        ...
        var hospital = hospitals.create(new HospitalRequest("RMQ-RECORD-1", "Record Test Hospital",
        ...
        var doctor = doctors.create(new DoctorRequest(hospital.id(), department.id(), "Dr. Record Test",
                "Internal Medicine", "RMQ-RECORD-REG-1", new BigDecimal("650.00"), 15, 10,
