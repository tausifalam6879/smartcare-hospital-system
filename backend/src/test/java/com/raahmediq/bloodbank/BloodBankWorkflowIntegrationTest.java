package com.raahmediq.bloodbank;
...
import com.raahmediq.bloodbank.domain.BloodUrgency;
...
import com.raahmediq.bloodbank.service.BloodBankService;
...
class BloodBankWorkflowIntegrationTest {
    ...
    void verifiedInventoryIsReservedSafelyAndVisibleOnlyThroughAuthorizedWorkflow() {
        var hospital = hospitals.create(new HospitalRequest("RMQ-BLOOD-1", "Blood Workflow Hospital",
        ...
        var doctor = doctors.create(new DoctorRequest(hospital.id(), department.id(), "Dr. Blood Safety",
                "Emergency Medicine", "RMQ-BLOOD-REG-1", new BigDecimal("800.00"), 15, 20,
        ...
        var bank = bloodBank.createBank(new BloodBankRequest(hospital.id(), "RMQ-BB-01",
