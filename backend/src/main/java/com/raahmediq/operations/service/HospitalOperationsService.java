package com.raahmediq.operations.service;
...
import com.raahmediq.operations.repository.AppointmentRecoveryCaseRepository;
import com.raahmediq.operations.repository.DoctorDayOperationRepository;
...
import com.raahmediq.operations.web.OperationsDtos.QueueRow;
        ...
        for (Appointment appointment : affected) {
            ...
            if (input.status() == DoctorDayStatus.CANCELLED_FOR_DAY
                ...
                notifications.notifyAppointment(appointment, NotificationType.APPOINTMENT_RECOVERY_REQUIRED,
                        ...
                        "The doctor is unavailable. Choose rescheduling or refund review; RaahMediQ Health will not move you automatically.");
            }
        }
