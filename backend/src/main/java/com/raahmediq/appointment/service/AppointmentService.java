package com.raahmediq.appointment.service;

import com.raahmediq.appointment.config.QueueProperties;
...
import com.raahmediq.appointment.repository.DoctorDayLedgerRepository;
import com.raahmediq.appointment.repository.WaitlistEntryRepository;
...
public class AppointmentService {
    ...
    @Scheduled(fixedDelayString = "${raahmediq.queue.expiry-scan-ms:60000}",
            initialDelayString = "${raahmediq.queue.expiry-initial-delay-ms:60000}")
    @Transactional
