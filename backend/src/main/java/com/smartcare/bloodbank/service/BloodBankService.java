...
import com.smartcare.bloodbank.config.BloodBankProperties;
...
import com.smartcare.bloodbank.repository.BloodAllocationRepository;
...
import com.smartcare.bloodbank.repository.BloodRequestRepository;
import com.smartcare.bloodbank.repository.DonorOptInRepository;
import com.smartcare.bloodbank.web.BloodBankDtos.AllocationResponse;
...
public class BloodBankService {
    ...
    public BloodRequestResponse createRequest(UUID actorUserId, CreateBloodRequest request) {
        ...
        notifications.notifyPatient(patient, hospital.getId(), NotificationType.BLOOD_REQUEST_CREATED,
                ...
                "Your care team created a blood-support request. Open SmartCare for verified status updates.");
